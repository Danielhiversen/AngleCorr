...
TEST_CASE("Test flow direction estimation 1", "[angle_correction][unit][flow_dirA]")
{
...
TEST_CASE("Test flow direction estimation 2", "[angle_correction][unit][flow_dir]")
{
...
TEST_CASE("Test flow direction estimation 3", "[angle_correction][unit][flow_dir]")
{
...
TEST_CASE("Test flow direction estimation 4", "[angle_correction][unit][flow_dir]")
{
...
TEST_CASE("Test flow direction estimation 5", "[angle_correction][unit][flow_dir]")
{
...
TEST_CASE("Test flow direction estimation 6", "[angle_correction][unit][flow_dir]")
{
...
TEST_CASE("Test flow direction estimation 7, aliasing", "[angle_correction][unit][aliasing]")
{
...
TEST_CASE("Test flow direction estimation 8, aliasing", "[angle_correction][unit][aliasing]")
{
...
TEST_CASE("Test flow direction estimation 9, cross movement", "[angle_correction][unit]")
{
...
TEST_CASE("Test flow direction estimation 10, cross movement", "[angle_correction][unit]")
{
...
TEST_CASE("Test Invalid parameters", "[angle_correction][unit]")
{
...
TEST_CASE("Test several runs", "[angle_correction][unit]")
{
    char centerline[] = "/2015-05-27_12-02_AngelCorr_tets.cx3/Images/US_10_20150527T131055_Angio_1_tsf_cl1.vtk";
    char image_prefix[] = "/2015-05-27_12-02_AngelCorr_tets.cx3/US_Acq/US-Acq_10_20150527T131055/US-Acq_10_20150527T131055_Velocity_";
...
TEST_CASE("Test several runs cl pointer input", "[angle_correction][unit]")
{
...
TEST_CASE("Benchmark", "[angle_correction][unit][Benchmark]")
{
    clock_t start, stop;
    double run_time = 0.0;
    start = clock();
...
TEST_CASE("Test several runs cl pointer input simple", "[angle_correction][unit][simple]")
{
